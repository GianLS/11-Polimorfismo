...
//		System.out.println(funcionario.getBonificacao());
		...
		System.out.println("Gerente autenticado? " + (gerente.autenticarGerente(123456) ? "Sim" : "Não"));

		EditorVideo editor = new EditorVideo();
		editor.setNome("Homer Simpson");
		editor.setSalario(2500.0);

		Designer designer = new Designer();
		designer.setNome("Marge Simpson");
		...
		System.out
				.println("O total pago em bonificação a todos os funcionários foi: R$" + calculo.getTotalBonificacao());
	}
}
